...
def main():
    ...
    # Optimizer - CASMO. robustness=1.0 because CIFAR-10 augmentation makes
    # per-batch gradients noisy; raise it further if labels are corrupted.
    optimizer = CASMO(model.parameters(), lr=0.1, weight_decay=5e-4, robustness=1.0)
